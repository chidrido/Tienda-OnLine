$(function () {
    ...
    //llama al selector especial
    $('#select_especial').on('change', function () {
        select_cat = document.getElementById('select_especial').value;
        select_action = "busca_datos_especial";
        tabla_oferta();
    });
